...
a<-xyplot( FSMEgt + rki ~ time, data = masterall, type = "l",
           xlab = "Time", ylab = "Weekly number",
...
fitGT ## xreg is insignificant
a<-AIC( fit, fitGT ) ## fit has a favorable AIC
a
...
layout(1)
plot( fc, col = "black", ylab = "Number of cases", main = "Predictions", ylim=c(0, 55) )
lines( fcGT$mean, col = "red" )
